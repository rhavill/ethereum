...
# contract = '77045e71a7a2c50903d88e564cd72fab11e82051'
print ' Contract address is ' + contract



# # Send a new transaction to the existing contract to register "george" to 45 after packging the data.
tx2 = transactions.Transaction(1,10**12,10000,contract,0,serpent.encode_datalist(['george',40])).sign(key)
...
# # Send a new transaction to the existing contract to register "george" to 45 after packging the data.
tx3 = transactions.Transaction(2,10**12,10000,contract,0,serpent.encode_datalist(['ted',51])).sign(key)
...
# # Send a new transaction to the existing contract to register "george" to 45 after packging the data.
tx4 = transactions.Transaction(3,10**12,10000,contract,0,serpent.encode_datalist(['ted',50])).sign(key)
...
storage_data = genesis.get_storage_data(contract,'ted')
print 'Storage data ' + str(storage_data)